  ...
  return (
    <div className="space-y-12">
      ...
      <div className="space-y-16">
        {metrics.map((metric) => {
          // Use centralized icon if available, otherwise fallback to the provided icon or a default
          const IconComponent = METRIC_ICONS[metric.label] ||
            (typeof metric.icon === 'function' ? metric.icon : TrendingUp);
